...
public class SudokuFileWriteException extends RuntimeException {
    public static final String FILE_WRITE_ERROR = "error.writeProblem";

    public SudokuFileWriteException(String message) {
        super(message);
    }
}
